...
public class ImageListView extends Activity implements AdapterView.OnItemClickListener {

    private ListView listView;

    public static final String GET_IMAGE_URL="http://saassignment.16mb.com/imageUpload/getAllImages.php";
